...
<svg id="ukeChordSvg" width="90" height="112" viewBox="0 0 90 112"
  ...
  <g id="svgChord" transform="translate(19,12)">
    ...
    <rect id="nut" height="4" width="62" fill="#cba154" style="visibility: hidden;"/>
    ...
    <g id="strings" transform="translate(0,2)">
      <rect height="80" width="2" x="0"  fill="#cba154"/>
      <rect height="80" width="2" x="20" fill="#cba154"/>
      <rect height="80" width="2" x="40" fill="#cba154"/>
      <rect height="80" width="2" x="60" fill="#cba154"/>
    </g>
    <g id="frets" transform="translate(0,2)">
      <rect height="2" width="62" y="0"  fill="#cba154"/>
      <rect height="2" width="62" y="20" fill="#cba154"/>
      <rect height="2" width="62" y="40" fill="#cba154"/>
      <rect height="2" width="62" y="60" fill="#cba154"/>
      <rect height="2" width="62" y="80" fill="#cba154"/>
    </g>
    <g id="closedStrings" transform="translate(1,13)">
      <g id=closedString0 style="visibility: hidden;">
        <circle r="6"/>
        <text fill="#000000" id="finger0" y="4" text-anchor="middle"></text>
      </g>
      <g id="closedString1" style="visibility: hidden;">
        <circle r="6"/>
        <text fill="#000000" id="finger1" y="4" text-anchor="middle"></text>
      </g>
      <g id="closedString2" style="visibility: hidden;">
        <circle r="6"/>
        <text fill="#000000" id="finger2" y="4" text-anchor="middle"></text>
      </g>
      <g id="closedString3" style="visibility: hidden;">
        <circle r="6"/>
        <text fill="#000000" id="finger3" y="4" text-anchor="middle"></text>
      </g>
    </g>
    <g id="openStrings" transform="translate(1,-5)">
      <circle id="openString0" cx="0"  r="4" fill="none" stroke="#cba154" stroke-width="1" style="visibility: hidden;"/>
      <circle id="openString1" cx="20" r="4" fill="none" stroke="#cba154" stroke-width="1" style="visibility: hidden;"/>
      <circle id="openString2" cx="40" r="4" fill="none" stroke="#cba154" stroke-width="1" style="visibility: hidden;"/>
      <circle id="openString3" cx="60" r="4" fill="none" stroke="#cba154" stroke-width="1" style="visibility: hidden;"/>
    </g>
